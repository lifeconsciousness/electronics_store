                ...
                <div className="max-w-screen-xl pt-16 pb-6 mx-auto sm:px-12 lg:px-8 lg:pt-24">
                    <div className="grid grid-cols-1 gap-24 lg:grid-cols-3">
                        ...
                        >
                            ...
                            <div className="text-center sm:text-left">
                                <p className="text-3xl font-medium text-white">Our Services</p>
                            ...
                            <div className="text-center sm:text-left">
                                <p className="text-3xl font-medium text-white">Helpful Links</p>
                                <nav className="mt-8">
                                    <ul className="space-y-4 text-xl">
                                        <li>
                                            <a className="text-white transition hover:text-white/75" href="/">
                            ...
                            <div className="text-center sm:text-left">
                                <p className="text-3xl font-medium text-white">Contact Us</p>
                    ...
                    <div className="pt-6 mt-12 border-t border-gray-500">
