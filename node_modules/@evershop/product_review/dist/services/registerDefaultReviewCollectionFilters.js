...
export default async function registerDefaultReviewCollectionFilters() {
    ...
    const defaultFilters = [
        ...
        },
        {
            ...
            operation: "eq",
            callback: (query, operation, value, currentFilters) => {
                query.andWhere("product_review.status", OPERATION_MAP[operation], value);
                currentFilters.push({
                    key: "status",
                    operation,
                    value,
        ...
        },
        {
            ...
            operation: "eq",
            callback: (query, operation, value, currentFilters) => {
                const productReviewCollectionSortBy = getValueSync("productReviewCollectionSortBy", {
...
//# sourceMappingURL=registerDefaultReviewCollectionFilters.js.map